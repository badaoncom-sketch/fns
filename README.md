...
- **의사결정 추적**: [DECISIONS.md](docs/DECISIONS.md)(D-001~D-069 확정 결정 + O-002~O-194 Open Decision) · [CHANGELOG.md](docs/CHANGELOG.md) · [GAP-ANALYSIS.md](docs/GAP-ANALYSIS.md)(상용 ERP 대비 점검)
...
135개+ 엔터티를 13개 도메인 클러스터로 묶어 Mermaid ER 다이어그램으로 정리했다(D-069로 쇼핑몰 운영/SEO 신규 테이블 18종 추가 — ERD.md 다이어그램 자체는 다음 갱신 라운드에서 반영). [ERD.md](docs/ERD.md) 참조 — 원본 텍스트 정의는 [DATABASE.md](docs/DATABASE.md) §3.
