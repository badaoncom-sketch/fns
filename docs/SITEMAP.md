...
> 상태: v0.2 ([DECISIONS.md](DECISIONS.md) D-069 — 쇼핑몰 운영 고도화/SEO 메뉴 추가: §1.2~1.4/§1.12 신규 메뉴) · 최종 수정일: 2026-06-26 · 단계: 설계(Design)
...
| 상품상세 | 재입고알림 신청 | | [PRD.md](PRD.md) §5.41 |
| 장바구니 | | | [PRD.md](PRD.md) §5.1.3.5 |
| 주문서(결제 전) | 쿠폰 적용 | | [PRD.md](PRD.md) §5.1.3.5, §5.21 |
| 결제 | PG 연동 | 자동결제와 동일 정책 공유 예정(미확정) | [PRD.md](PRD.md) §5.1.3.5 |
| 주문완료 | | | [PRD.md](PRD.md) §5.1.3.5 |
| 배송조회 | | 3PL/물류 연동 결과 노출 | [PRD.md](PRD.md) §5.1.3.5 |
| 반품/교환/환불 신청 | | 청약철회권 연계 | [PRD.md](PRD.md) §5.1.3.5, §5.5 |
...
| 마이페이지 (로그인 회원) | 위시리스트 / 최근 본 상품 | | [PRD.md](PRD.md) §5.21 |
...
| 1Depth | 2Depth | 3Depth | 근거 |
|---|---|---|---|
| Notification Center | 알림 템플릿 관리 | 채널/언어/국가별 템플릿(템플릿 버전관리) | [PRD.md](PRD.md) §5.12, §5.34 |
| Notification Center | 발송 설정 | 예약발송/조건발송/국가별/회원유형별/대상그룹 발송 | [PRD.md](PRD.md) §5.34 |
| Notification Center | 자동발송 | 이벤트 기반(주문완료 등) | [PRD.md](PRD.md) §5.34 |
...
| Dashboard Builder | 위젯 유형 선택 | 차트/테이블/KPI | [PRD.md](PRD.md) §5.36 |
